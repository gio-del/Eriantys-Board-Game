...
public class SchoolSmall {
     ...
     */
    public SchoolSmall(ShortSchool school, ShortPlayer player, int coin, Assistant playedAssistant) {
    ...
    private String assistantBuilder(Assistant playedAssistant) {
        if (playedAssistant == null) return empties(Constants.SCHOOL_SHORT_WIDTH);
        StringBuilder stringBuilder = new StringBuilder();
