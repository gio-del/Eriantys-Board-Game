...
class BoardTest {
    ...
    void conquerIslandWithoutTower() {
        game.getBoard().setMotherNaturePos(2);
        game.getBoard().moveMotherNature(2);
        assertEquals(TowerColor.WHITE, game.getBoard().calculateInfluence(game.getPlayers()));
    }
    ...
    void conquerIslandWithTowerOfTheWinner() {
        ...
        game.getBoard().moveMotherNature(2);
        assertNull(game.getBoard().calculateInfluence(game.getPlayers()));
    }
    ...
    void conquerIslandWithTowerOfTheLoser() {
        ...
        game.getBoard().moveMotherNature(2);
        assertEquals(WHITE, game.getBoard().calculateInfluence(game.getPlayers()));
    }
    ...
    void motherNatureMovementLoopArray() {
        ...
        game.getBoard().moveMotherNature(4);
    ...
    void mushroomSellerStrategy() {
        game.getBoard().setStrategy(new MushroomSellerStrategy(GREEN));
        game.getBoard().setMotherNaturePos(10);
        game.getBoard().moveMotherNature(3);
    ...
    void centaurStrategy() {
        game.getBoard().setStrategy(new CentaurStrategy());
        game.getBoard().setMotherNaturePos(10);
    ...
    @Test
    void KnightStrategy() {
        game.getBoard().setStrategy(new KnightStrategy(BLACK));
        game.getBoard().setMotherNaturePos(10);
        game.getBoard().moveMotherNature(3);

        assertEquals(BLACK, game.getBoard().calculateInfluence(game.getPlayers()));
    }
    ...
    void conquerIslandAndTriggerAdjacencies() {
        ...
        game.getBoard().calculateInfluence(game.getPlayers());
    ...
    void sumOfPawns() {
        ...
        assertEquals(new Pawns(4, 4, 10, 3, 12), game.getBoard().getIslands().get(3).getStudents());

        assertEquals(2, game.getBoard().getIslands().get(3).getBanTiles());
